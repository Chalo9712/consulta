...
server = '181.143.60.243'  # Reemplaza con el nombre de tu servidor SQL Server
database = 'django'  # Reemplaza con el nombre de tu base de datos
username = 'sa'  # Reemplaza con tu nombre de usuario
password = '43621612'  # Reemplaza con tu contraseña
...
def search():
    try:
        ...
        select_query = "SELECT NOMBRE, VALOR FROM consulta WHERE CODIGO = ?"
